...
public class TapRuleImpl extends JsObjectImpl implements TapRule {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIs(TelehashObject newIs,
			NotificationChain msgs) {
		TelehashObject oldIs = is;
		is = newIs;
	 ...
	 * @generated
	 */
	public TapRule withIs(TelehashObject value) {
		setIs(value);
		return this;
	}

	public void setIs(TelehashObject newIs) {
		if (newIs != is) {

...
* Hashname - The SHA1(public key + network) of a RSA keypair that is part of a network, the unique ID of an individual application/instance using telehash
